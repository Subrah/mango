Mango::Application.routes.draw do
  ...
  match 'reports/consumption_variation_per_batch_plot' => "reports#consumption_variation_per_batch_plot", :via => :post, :as => "consumption_variation_per_batch_plot_report"
  match 'reports/order_consumption_variation_per_batch_plot' => "reports#order_consumption_variation_per_batch_plot", :via => :post, :as => "order_consumption_variation_per_batch_plot_report"
